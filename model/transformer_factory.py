...
def new_mel_transformer(start_vec,
    ...
    speech_out_module = SpeechOutModule(mel_channels=mel_channels,
                                        conv_filters=postnet_conv_filters,
                                        conv_layers=postnet_conv_layers,
                                        kernel_size=postnet_kernel_size)

    mel_transformer = MelTransformer(encoder_prenet=PointWiseFFN(d_model=d_model, dff=dff),
                                     decoder_prenet=PointWiseFFN(d_model=d_model, dff=dff),
                                     encoder=encoder,
                                     decoder=decoder,
