...
from utils import create_masks, masked_loss_function
...
class Transformer(tf.keras.Model):
    ...
    def __init__(self, num_layers, d_model, num_heads, dff, pe_input, pe_target, vocab_size: dict, rate=0.1):
        ...
        self.encoder = Encoder(num_layers, d_model, num_heads, dff, vocab_size['in'], pe_input, rate)
        self.decoder = Decoder(num_layers, d_model, num_heads, dff, vocab_size['out'], pe_target, rate)
