...
class TextToTokens:
    def __init__(self, phonemizer, tokenizer):
    ...
    @classmethod
    def default(cls, language, add_start_end, with_stress, njobs=1, strip=False):
    ...
    @classmethod
    def default_training(cls, language, add_start_end, with_stress, njobs=4):
